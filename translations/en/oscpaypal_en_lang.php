...
$aLang = [
    ...
    'OSCPAYPAL_KILL_EXPRESS_SESSION_REASON'         => 'The shopping cart has been changed. That is why the active PayPal payment process is automatically canceled. Please restart the payment with PayPal. No money has been collected from PayPal yet.',
];
